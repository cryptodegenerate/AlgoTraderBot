...
export const botSettings = pgTable("bot_settings", {
  ...
  symbols: text("symbols").default("BTC/USDT,ETH/USDT,SOL/USDT,ASTR/USDT,PEPE/USDT,DOGE/USDT,SHIB/USDT,WIF/USDT"),
  timeframe: text("timeframe").default("1m"),
  riskPerTrade: real("risk_per_trade").default(0.015),
  dailyMaxDD: real("daily_max_dd").default(0.03),
  maxConcurrentPos: integer("max_concurrent_pos").default(2),
  hhvLen: integer("hhv_len").default(35),
  atrLen: integer("atr_len").default(12),
  atrMultSL: real("atr_mult_sl").default(1.5),
  atrMultTrail: real("atr_mult_trail").default(2.0),
  volZMin: real("vol_z_min").default(1.5),
  lookback: integer("lookback").default(150),
  dryRun: boolean("dry_run").default(true),
